...
let handleSubmit = async (e) => {
  ...
  return (<>
  <div class="bg-green-200 pb-40">
  <div class="flex justify-center items-center h-screen ">
    <form class="max-w-lg mx-center p-8 bg-white rounded shadow-lg md:items-center mt-40" onSubmit={handleSubmit}>
        ...
        <div class="mb-4">
          ...
          <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="donor-name" value={name} onChange={(e) => setName(e.target.value)} type="text" placeholder="Your name" required/>
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
          ...
          <div class="relative">
            <select class="block appearance-none w-full border rounded py-2 px-3 leading-tight focus:outline-none focus:shadow-outline" id="food-type" value={foodType} onChange={(e) => setFoodType(e.target.value)} required>
        ...
        <div class="mb-4">
          ...
          <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="quantity" value={quantity} onChange={(e) => setQuantity(e.target.value)} type="number" placeholder="Quantity in kgs" required/>
        </div>
        <div class="mb-4">
          <label class="block text-gray-700 font-bold mb-2" for="location">Pickup Location</label>
          <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="location" value={pickupLocation} onChange={(e) => setPickupLocation(e.target.value)} type="text" placeholder="Address" required/>
        </div>
        <div class="mb-4">
          <label class="block text-gray-700 font-bold mb-2" for="date">Pickup Date</label>
          <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="date" value={pickupDate} onChange={(e) => setPickupDate(e.target.value)} type="date" required/>
       </div>
       <div class="mb-4">
